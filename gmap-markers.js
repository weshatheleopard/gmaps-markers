...
function setZoom(container_id, items_lenght, lats, lngs) {
	...
	if ((extremes > 0.0) && (extremes <= 0.0001)) {
		zoom_par = 20;
	} else if ((extremes > 0.0001) && (extremes <= 0.0002)) {
		zoom_par = 19;
	} else if ((extremes > 0.0002) && (extremes <= 0.0003)) {
		zoom_par = 18;
	} else if ((extremes > 0.0003) && (extremes <= 0.0007)) {
		zoom_par = 17;
	} else if ((extremes > 0.0007) && (extremes <= 0.0015)) {
		zoom_par = 16;
	} else if ((extremes > 0.0015) && (extremes <= 0.003)) {
		zoom_par = 15;
	} else if ((extremes > 0.003) && (extremes <= 0.007)) {
		zoom_par = 14;
	} else if ((extremes > 0.007) && (extremes <= 0.0125)) {
		zoom_par = 13;
	} else if ((extremes > 0.0125) && (extremes <= 0.025)) {
		zoom_par = 12;
	} else if ((extremes > 0.025) && (extremes <= 0.05)) {
		zoom_par = 11;
	} else if ((extremes > 0.05) && (extremes <= 0.1)) {
		zoom_par = 10;
	} else if ((extremes > 0.1) && (extremes <= 0.2)) {
		zoom_par = 9;
	} else if ((extremes > 0.2) && (extremes <= 0.4)) {
		zoom_par = 8;
	} else if ((extremes > 0.4) && (extremes <= 0.7)) {
		zoom_par = 7;
	} else if ((extremes > 0.7) && (extremes <= 1.5)) {
		zoom_par = 6;
	} else if ((extremes > 1.5) && (extremes <= 3.0)) {
		zoom_par = 5;
	} else if ((extremes > 3.0) && (extremes <= 7.0)) {
		zoom_par = 4;
	} else if ((extremes > 7.0) && (extremes <= 15.0)) {
		zoom_par = 3;
	} else if ((extremes > 15.0) && (extremes <= 25.0)) {
		zoom_par = 2;
	} else if ((extremes > 25.0) && (extremes <= 50.0)) {
		zoom_par = 1;
	} else if ((extremes > 50.0) && (extremes <= 100.0)) {
		zoom_par = 0;
	}
	//  ####  WAITING CODE #########
